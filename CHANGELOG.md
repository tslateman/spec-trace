...
Work since the v10 milestone: corpus-backed spec review, the impact graph,
and the API v1 surface.

<!-- changelog:auto since=cd4aa16 (generated by `make changelog` — edit at release time) -->
