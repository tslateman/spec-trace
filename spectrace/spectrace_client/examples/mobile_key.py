...
def validate_ambiance_mobile_key(hotel_id: int, feature_flags: dict[str, bool] | None = None) -> Any:
...
def _test_vostio_lock_management(config: dict, credentials: dict) -> list[dict]:
    ...
    return [{'lock_id': 'LOCK-101', 'status': 'online'}, {'lock_id': 'LOCK-102', 'status': 'online'}]
