...
from requirements.models import Requirement, InAppValidation, InAppValidationStatus
...
class TestSDKPhase2Integration:
    ...
    def test_api_accepts_extended_fields(self):
        ...
        result = ValidationResult(
            ...
            steps=[
                ValidationStep(name='config', passed=True, details='Config OK', timestamp=datetime.fromisoformat('2024-01-01T10:00:00Z')),
                ValidationStep(name='auth', passed=True, details='Auth OK', timestamp=datetime.fromisoformat('2024-01-01T10:00:01Z')),
                ValidationStep(name='connect', passed=False, error_message='Timeout', timestamp=datetime.fromisoformat('2024-01-01T10:00:02Z')),
            ],
            context={
                'vendor': 'Opera',
                'hotel_id': 123,
    ...
    def test_regression_detection(self):
        ...
        from requirements.models import InAppValidationRun, InAppValidationResult
    ...
    def test_vendor_coverage_view(self):
        ...
        InAppValidation.objects.create(
            requirement=req1,
            name='Opera Validation',
            vendor='Opera'
        )
        
        InAppValidation.objects.create(
            requirement=req2,
            name='Mews Validation',
            vendor='Mews'
        )
