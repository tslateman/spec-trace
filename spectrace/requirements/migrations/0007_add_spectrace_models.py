...
class Migration(migrations.Migration):
    dependencies = [
        (
            "requirements",
            "0006_inappvalidation_feature_flags_inappvalidation_vendor_and_more",
        ),
    ]
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            field=models.DateTimeField(
                blank=True, help_text="When the test run finished", null=True
            ),
        ),
        migrations.AddField(
            model_name="testrun",
            ...
            field=models.CharField(
                blank=True, help_text="Git branch for this test run", max_length=200
            ),
        ),
        migrations.AddField(
            model_name="testrun",
            name="git_sha",
            field=models.CharField(
                blank=True, help_text="Git commit SHA for this test run", max_length=40
            ),
        ),
        migrations.AddField(
            model_name="testrun",
            name="started_at",
            field=models.DateTimeField(
                blank=True, help_text="When the test run started", null=True
            ),
        ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "last_run_at",
                    models.DateTimeField(
                        blank=True, help_text="When this test was last run", null=True
                    ),
                ),
                (
                    "needs_review",
                    models.BooleanField(default=False, help_text="Flag for manual review needed"),
                ),
                (
                    "review_reason",
                    models.CharField(
